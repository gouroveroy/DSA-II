...
class HashTable
{
     ...
     *
     * @return The function `Hash1` returns an long long integer value, which is the hash value of the given key.
     */
    long long Hash1(string key)
    {
        long long p = nextPrime(2 * capacity);
    ...
    void rehash(long long C)
    {
        ...
        // {
        //     vector<pair<string, long long>> temp = doubleHash;
        //     capacity = nextPrime(2 * capacity);
        //     doubleHash.clear();
        //     doubleHash.resize(capacity, pair<string, long long>());
        ...
        // {
        //     vector<pair<string, long long>> temp = customProbe;
        //     capacity = nextPrime(2 * capacity);
        //     customProbe.clear();
        //     customProbe.resize(capacity, pair<string, long long>());
        //     for (long long i = 0; i < temp.size(); i++)
        //     {
        //         if (temp[i].first != 0)
        //         {
